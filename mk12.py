...
def get_waypoints():
    ...
    waypoints.append([4.01000, 4.58029])
    waypoints.append([3.82994, 4.54512])
    waypoints.append([3.65152, 4.50938])
    waypoints.append([3.47325, 4.47952])
    waypoints.append([3.28266, 4.46001])
    waypoints.append([3.10639, 4.45420])
    waypoints.append([2.91446, 4.46456])
    waypoints.append([2.73708, 4.49095])
    waypoints.append([2.54834, 4.53168])
    waypoints.append([2.36536, 4.56458])
    ...
    waypoints.append([0.47230, 2.85944])
    waypoints.append([0.49886, 2.66878])
    waypoints.append([0.52386, 2.49611])
    waypoints.append([0.54445, 2.33133])
    waypoints.append([0.56502, 2.12412])
    waypoints.append([0.57672, 1.94009])
